...
import createFarmImg from "@/assets/create-farm.png";
import stakeImg from "@/assets/stake.png";
import improveOptimizeImg from "@/assets/improve-optimize.png";
...
const images = [createFarmImg, stakeImg, improveOptimizeImg];
