        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {translations.steps.map((step, index) => {
            ...
            return (
              <Card 
                key={index}
                className="bg-card/90 backdrop-blur-sm border-4 border-secondary/30 hover:border-secondary transition-all duration-300 hover:scale-105 hover:shadow-2xl"
              >
                <CardContent className="p-8 text-center space-y-4">
                  <div className="w-20 h-20 mx-auto bg-secondary rounded-full flex items-center justify-center shadow-xl">
                    <Icon className="w-10 h-10 text-secondary-foreground" />
                  </div>
                  <div className="w-12 h-12 mx-auto bg-primary rounded-full flex items-center justify-center -mt-2 shadow-lg">
